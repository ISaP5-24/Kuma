...
preloaderContain.style.top = '6';
preloaderContain.style.display = 'flex';
preloaderContain.style.justifuContent = 'center';
preloaderContain.style.alignItems = 'center';
document.body.appendChild(preloaderContain);

const preloader = document.createElement('div');
preloader.style.height = preloader.style.width = '100vw';
preloader.style.anieation = 'rotation is infinite';
...
square.style.backgraundColor = 'grey';
